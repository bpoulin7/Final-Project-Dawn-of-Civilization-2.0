# Map module - contains all aspects of the game map and setting
...
mitanni.desc = """a young empire in Upper Mesopotamia, ruled by Hurrian kings
from the north."""
...
Nile River, whose sphere of influence now spreads north along the Levantine
coast."""
...
meliddu.desc = """an ancient city on the edge of Hittite sphere of
influence"""

lukka = Location(0, 2)
lukka.name = "Lukka"
lukka.owner = arzawa
lukka.desc = """now an insignificant corner of Anatolia, soon to be a major
kingdom of its own"""
...
ugarit.name = "Ugarit"
ugarit.owner = egypt
ugarit.desc = """a port city that once had its own empire, now under Egyptian
control"""

emar = Location(2, 3)
emar.name = "Emar"
emar.owner = mitanni
emar.desc = """a crucial Bronze Age trade hub at the crossroads of
civilization"""
...
palmyra.owner = egypt
palmyra.desc = """one of the few significant settlements in the Arabian
desert"""

kurigalzu = Location(3, 4)
kurigalzu.name = "Dur-Kurigalzu"
kurigalzu.owner = babylonia
kurigalzu.desc = """the newly-built capital of Babylonia under the Kassite
dynasty"""
...
jericho.owner = egypt
jericho.desc = """the oldest city in the world, with magnificent protective
walls"""

babylon = Location(4, 6)
babylon.name = "Babylon"
babylon.owner = babylonia
babylon.desc = """the legendary city, currently the most populous in the
world"""
...
nippur.desc = """a strategically important city disputed between Babylonian
and Sumerian control"""

susa = Location(7, 6)
susa.name = "Susa"
susa.owner = elamites
susa.desc = """the northern of the two Elamite cities, considered an imposter
...
heliopolis.desc = """the future sight of Cairo, a magnificent city at the head
of the Nile Delta"""
...
memphis.owner = egypt
memphis.desc = """the seat of the Pharaoh of Egypt, and one of the most
...
anshan.desc = """the southern of the two Elamite cities, perpetually
suspicious of its northern competitor"""
...
map_tiles = [
    ...
    [apasa, kummanni, meliddu, Mountains(3, 1), Mountains(4, 1),
     Mountains(5, 1), Mountains(6, 1), Sea(7, 1), Sea(8, 1)],
    ...
    [Sea(0, 4), byblos, palmyra, Desert(3, 4), kurigalzu, eshnunna,
     Mountains(6, 4), Mountains(7, 4), Mountains(8, 4)],
    [Sea(0, 5), tyre, Desert(2, 5), Desert(3, 5), sippar, upi,
     Mountains(6, 5), Mountains(7, 5), Mountains(8, 5)],
    [Sea(0, 6), ascalon, jericho, Desert(3, 6), babylon, kish, nippur, susa,
     warashi],
    [heliopolis, tjaru, Desert(2, 7), Desert(3, 7), Desert(4, 7),
     Desert(5, 7), uruk, Sea(7, 7), liyan],
