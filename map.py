...
class Desert(Location):
    """Deserts impossible to traverse."""
...
ugarit.name = "Ugarit"
ugarit.owner = egypt
ugarit.desc = ("a port city that once had its own empire, now under "
               + "Egyptian control")
...
warashi.desc = ("an enigmatic region on the eastern edge of civilization, "
                + "perhaps with connections to Central Asia")

heliopolis = Location(0, 7)
heliopolis.name = "Heliopolis"
heliopolis.owner = egypt
heliopolis.desc = ("the future sight of Cairo, a magnificent city at the"
                   + "head of the Nile Delta")
...
# Other # --------------------------------------------------------------------
map_tiles = [ # preset array of locations
